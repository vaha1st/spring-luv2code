...
public class MyDemoLoggingAspect {
	...
	public Object aroundGetFortune(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		// Handle the exception and return default result
		/*
		 * try { result=proceedingJoinPoint.proceed(); } catch (Exception e) { // log
		 * the exception myLogger.warning(e.getMessage());
		 * 
		 * // give the user custom message result = "Major accident! But no worries," +
